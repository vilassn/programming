...
main()
{
 ...
 while(1)
 {
  ...
  switch(choice)
  {
   case '1': openRecord(); break;
   case '2': listRecord(); break;
   case '3': createRecord(); break;
   case '4': manageRecord();break;
   case '5': help(); break;
   case '6': quit(); break;
   default: clrscr();printf("You have entered invalid choice\n");
  }//switch
 }//while
}//main
...
editRecord()
{
 ...
 while(1)
 {
  ...
  switch(choice)
  {
   ...
   case '3' : reverseEntries();break;
   case '4' : searchEntry();break;
   case '5' : sortEntry();break;
   case '6' : saveEntry();break;
   case '7' : clrscr();return 0;
